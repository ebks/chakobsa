...
*   **Raízes "Fracas" e Irregularidades:** O sistema se torna mais complexo quando a raiz contém consoantes consideradas "fracas". Estas não são fracas em som, mas em seu comportamento fonológico e morfológico, pois tendem a sofrer alterações (assimilação, elisão, mudança para vogal longa) quando entram em contato com certas vogais ou afixos. Isso leva a conjugações e derivações **irregulares** que se desviam dos padrões dos verbos "fortes" (com três consoantes fortes). As principais categorias de raízes fracas são:
    1.  **Verbos Hamzados (المَهْمُوز - *al-mahmūz*):** Contêm uma Hamza (**ء** *’* / /ʔ/) como C1, C2 ou C3. A Hamza pode mudar de forma ou de "suporte" (Alif, Waw, Ya) dependendo do ambiente vocálico.
        *   Ex (C1=ء): **أَكَلَ / يَأْكُلُ** (*akala/ya’kulu*, comer; raiz ’-K-L)
...
*   **Pessoa (الشَّخْص - *ash-shakhṣ* [R]):** Reflete a relação do sujeito com o falante. A forma verbal muda para indicar se o sujeito é:
...
Esta complexa teia de concordância é o que dá ao verbo Chakobsa/Árabe sua precisão e sua capacidade de transmitir múltiplas camadas de informação de forma compacta. Dominá-la é essencial para a fluência.
...
2.  **Aspecto Imperfectivo (المُضَارِع - *al-muḍāri‘* [R] - "O Semelhante [ao Nome]")**
    ...
    *   **Exemplos Detalhados (Raiz KTB - escrever; base Imperfectiva *ktub* com vogal /u/):**
        ...
        *   **يَكْتُبْنَ** (*yaktubna*) - Elas escrevem / escreverão.
...
2.  **Modo Imperativo (الأَمْر - *al-amr* [R] - "A Ordem")**
...
4.  **Modo Jussivo (المَجْزُوم - *al-majzūm* [R] – “O Apocopado/Cortado”)**
...
3.  **Negando o Presente/Futuro (Imperfectivo Indicativo - Negação Geral): Partícula لا (*lā*)**
...
6.  **Negando Frases Nominais (Presente "não é/está"): Verbo لَيْسَ (*laysa*)**
    ...
    *   **Exemplos:**
        ...
        *   **نَحْنُ لَسْنَا خَائِفِينَ۔** (*Naḥnu lasnā khā’ifīna.*) [R] - Nós não estamos com medo. (Plural acusativo/genitivo de *khā’if*).
...
*   **Forma IV (أَفْعَلَ / يُفْعِلُ - *’af‘ala / yuf‘ilu*): Prefixo Hamza**
...
*   **Forma VII (اِنْفَعَلَ / يَنْفَعِلُ - *infa‘ala / yanfa‘ilu*): Prefixo *in-***
...
*   **Particípio Passivo (اِسْمُ المَفْعُولِ - *ism al-maf‘ūl*, "nome do objeto/paciente"):** Descreve a entidade (pessoa ou coisa) que **recebeu** ou **sofreu** a ação do verbo. Corresponde frequentemente aos nossos particípios passados terminados em "-ado", "-ido" (escrito, compreendido, morto).
    ...
    *   **Formação (Formas Derivadas II-X):** É formado a partir da base do verbo **Imperfectivo Passivo** correspondente (ou do Imperfectivo Ativo, mas com mudança vocálica):
        ...
        *   F-VII (*yunfa‘**a**lu*): **مُنْفَعَل (به)** (*munfa‘al (bihi)*) - Afetado (por)
...
*   **Formação (Formas Derivadas II-X):** Em contraste com a irregularidade da Forma I, as formas verbais derivadas (II-X) geralmente têm **padrões de *maṣdar* regulares e previsíveis**, que são consistentes para a maioria dos verbos dentro de cada forma.
    ...
    *   F-VII (*infa‘ala*): Maṣdar **اِنْفِعَال** (*infi‘āl*)
        *   Ex: **اِنْكِسَار** (*inkisār*, quebra) de **اِنْكَسَرَ** (*inkasara*)
...
*   **Exemplo C3=ء (Raiz Q-R-’, ler): قَرَأَ / يَقْرَأُ (*qara’a/yaqra’u*)**
    ...
    *   Imperfectivo: **أَقْرَأُ** (*’aqra’u*), **تَقْرَأُ** (*taqra’u*), **يَقْرَأُ** (*yaqra’u*), etc. (Hamza final em Alif após Fatḥa)
    *   Imperativo: **اِقْرَأْ!** (*iqra’!*)

**6.11.2 Verbos Assimilados (المِثَال - *al-mithāl*)**
*   **Característica:** C1 = Waw (و) ou Ya (ي).
*   **Irregularidade Principal (Waw inicial, Forma I):** O Waw inicial **desaparece** na forma Imperfectiva Indicativa, Subjuntiva e Jussiva.
*   **Exemplo (Waw inicial, Raiz W-J-D, encontrar): وَجَدَ / يَجِدُ (*wajada/yajidu*)**
    *   Perfectivo: **وَجَدْتُ** (*wajadtu*), **وَجَدْتَ** (*wajadta*), **وَجَدَ** (*wajada*), etc. (Waw presente)
    *   Imperfectivo Indic.: **أَجِدُ** (*’ajidu*), **تَجِدُ** (*tajidu*), **يَجِدُ** (*yajidu*), etc. (**Waw desaparece**)
    *   Imperativo: **جِدْ!** (*jid!*) (Sem Alif inicial necessário, Waw já sumiu)
    *   Masdar: **وُجُود** (*wujūd*, existência) ou **جِدَة** (*jidah*, ato de encontrar)
*   **Nota (Ya inicial):** Verbos com Ya inicial (menos comuns) geralmente mantêm o Ya no Imperfectivo (e.g., *yabisa/yaybasu*).

**6.11.3 Verbos Ocos (الأَجْوَف - *al-ajwaf*)**
*   **Característica:** C2 = Waw (و) ou Ya (ي).
*   **Irregularidade Principal:** A consoante fraca medial e a vogal curta adjacente se fundem em uma **vogal longa** (ā, ū, ou ī) no Perfectivo (3ª pessoa) e Imperfectivo. Essa vogal longa **encurta ou desaparece** quando um sufixo começando com consoante é adicionado (e.g., no Perfectivo 1ª/2ª pessoas) ou no Jussivo/Imperativo com terminação Sukūn.
*   **Exemplo (Waw Oco, tipo *qāla*, Raiz Q-W-L, dizer): قَالَ / يَقُولُ (*qāla/yaqūlu*)**
    *   Perfectivo: **قُلْتُ** (*qultu*), **قُلْتَ** (*qulta*), **قَالَ** (*qāla*), **قَالَتْ** (*qālat*), **قُلْنَا** (*qulnā*), **قَالُوا** (*qālū*), etc. (Vogal longa /aː/ na 3ªp, encurta para /u/ antes de sufixo consonantal).
    *   Imperfectivo Indic.: **أَقُولُ** (*aqūlu*), **تَقُولُ** (*taqūlu*), **يَقُولُ** (*yaqūlu*), **تَقُولِينَ** (*taqūlīna*), **يَقُولُونَ** (*yaqūlūna*), etc. (Vogal longa /uː/).
    *   Jussivo: **لَمْ أَقُلْ** (*lam aqul*), **لَمْ تَقُلْ** (*lam taqul*), **لَمْ يَقُلْ** (*lam yaqul*) (Vogal longa /uː/ encurta para /u/ antes do Sukūn implícito).
    *   Imperativo: **قُلْ!** (*qul!*), **قُولِي!** (*qūlī!*), **قُولُوا!** (*qūlū!*) (Forma curta no masc. sg.).
*   **Exemplo (Ya Oco, tipo *sāra*, Raiz S-Y-R, viajar): سَارَ / يَسِيرُ (*sāra/yasīru*)**
    *   Perfectivo: **سِرْتُ** (*sirtu*), **سِرْتَ** (*sirta*), **سَارَ** (*sāra*), **سَارَتْ** (*sārat*), **سِرْنَا** (*sirnā*), **سَارُوا** (*sārū*), etc. (Vogal longa /aː/, encurta para /i/ antes de sufixo consonantal).
    *   Imperfectivo Indic.: **أَسِيرُ** (*asīru*), **تَسِيرُ** (*tasīru*), **يَسِيرُ** (*yasīru*), **تَسِيرِينَ** (*tasīrīna*), **يَسِيرُونَ** (*yasīrūna*), etc. (Vogal longa /iː/).
    *   Jussivo: **لَمْ أَسِرْ** (*lam asir*), **لَمْ تَسِرْ** (*lam tasir*), **لَمْ يَسِرْ** (*lam yasir*) (Vogal longa /iː/ encurta para /i/).
    *   Imperativo: **سِرْ!** (*sir!*), **سِيرِي!** (*sīrī!*), **سِيرُوا!** (*sīrū!*).

**6.11.4 Verbos Defectivos (النَّاقِص - *an-nāqiṣ*)**
*   **Característica:** C3 = Waw (و) ou Ya (ي).
*   **Irregularidade Principal:** A terminação do verbo é altamente irregular. A vogal fraca final frequentemente aparece como **Alif Maqṣūrah (ى)** (pronunciado *-ā*), ou interage de forma complexa com os sufixos de concordância, às vezes desaparecendo ou mudando.
*   **Exemplo (Ya final, tipo *ramā*, Raiz R-M-Y, jogar): رَمَى / يَرْمِي (*ramā/yarmī*)**
    *   Perfectivo: **رَمَيْتُ** (*ramaytu*), **رَمَيْتَ** (*ramayta*), **رَمَى** (*ramā*), **رَمَتْ** (*ramat*), **رَمَيْنَا** (*ramaynā*), **رَمَوْا** (*ramaw* - Waw aparece!), **رَمَيْنَ** (*ramayna*), etc. (Final *-ā* na 3Msg, *-at* na 3Fsg, *-ay-* antes de sufixos consonantais, *-aw* antes de -ū).
    *   Imperfectivo Indic.: **أَرْمِي** (*armī*), **تَرْمِي** (*tarmī*), **يَرْمِي** (*yarmī*), **تَرْمِينَ** (*tarmīna*), **يَرْمُونَ** (*yarmūna* - Ya some!), **يَرْمِينَ** (*yarmīna*), etc. (Final *-ī*, mas muda antes de *-ūna*).
    *   Jussivo: **لَمْ أَرْمِ** (*lam armi*), **لَمْ تَرْمِ** (*lam tarmi*), **لَمْ يَرْمِ** (*lam yarmi*) (Vogal final longa é removida).
    *   Imperativo: **اِرْمِ!** (*irmi!*), **اِرْمِي!** (*irmī!*), **اِرْمُوا!** (*irmū!*).
*   **Exemplo (Waw final, tipo *da‘ā*, Raiz D-‘-W, chamar): دَعَا / يَدْعُو (*da‘ā/yad‘ū*)**
    *   Perfectivo: **دَعَوْتُ** (*da‘awtu*), **دَعَوْتَ** (*da‘awta*), **دَعَا** (*da‘ā*), **دَعَتْ** (*da‘at*), **دَعَوْنَا** (*da‘awnā*), **دَعَوْا** (*da‘aw*), **دَعَوْنَ** (*da‘awna*), etc. (Similar a Ya-final, mas com Waw aparecendo antes de sufixos).
    *   Imperfectivo Indic.: **أَدْعُو** (*ad‘ū*), **تَدْعُو** (*tad‘ū*), **يَدْعُو** (*yad‘ū*), **تَدْعِينَ** (*tad‘īna* - Waw vira Ya!), **يَدْعُونَ** (*yad‘ūna*), **يَدْعُونَ** (*yad‘ūna* - 3Fpl igual 3Mpl!), etc. (Final *-ū*, mas muda antes de *-īna*).
    *   Jussivo: **لَمْ أَدْعُ** (*lam ad‘u*), **لَمْ تَدْعُ** (*lam tad‘u*), **لَمْ يَدْعُ** (*lam yad‘u*) (Vogal final longa removida).
    *   Imperativo: **اُدْعُ!** (*ud‘u!*), **اُدْعِي!** (*ud‘ī!*), **اُدْعُوا!** (*ud‘ū!*).

**6.11.5 Verbos Geminados/Dobrados (المُضَعَّف - *al-muḍa‘‘af*)**
*   **Característica:** C2 e C3 são idênticas.
*   **Irregularidade Principal:** Em muitas formas (especialmente 3ª pessoa do Perfectivo, todo o Imperfectivo e Imperativo), as duas consoantes idênticas se fundem com **Shadda (ــّـ)** e a vogal curta que estaria entre elas é omitida ou absorvida. No entanto, quando um sufixo começando com consoante é adicionado no Perfectivo (1ª e 2ª pessoas), a geminação é **desfeita** e a vogal reaparece.
*   **Exemplo (Raiz M-R-R, passar): مَرَّ / يَمُرُّ (*marra/yamurru*)**
    *   Perfectivo: **مَرَرْتُ** (*marartu*), **مَرَرْتَ** (*mararta*), **مَرَّ** (*marra*), **مَرَّتْ** (*marrat*), **مَرَرْنَا** (*mararnā*), **مَرُّوا** (*marrū*), **مَرَرْنَ** (*mararna*), etc. (Geminação desfeita antes de *-tu, -ta, -ti, -nā, -tum, -tunna, -na*; mantida antes de *-at, -ū*).
    *   Imperfectivo Indic.: **أَمُرُّ** (*amurru*), **تَمُرُّ** (*tamurru*), **يَمُرُّ** (*yamurru*), **تَمُرِّينَ** (*tamurrīna*), **يَمُرُّونَ** (*yamurrūna*), **يَمْرُرْنَ** (*yamrurna* - geminação desfeita aqui!), etc. (Shadda mantida na maioria das formas).
    *   Jussivo: **لَمْ أَمْرُرْ** (*lam amrur*) / **لَمْ أَمُرَّ** (*lam amurra*) (Formas variam)
    *   Imperativo: **مُرَّ!** (*murra!*) / **اُمْرُرْ!** (*umrur!*) (Formas variam).

**6.11.6 Verbos Duplamente Fracos (اللَّفِيف - *al-lafīf*)**
*   Combinam as irregularidades de dois tipos de fraqueza. Ex: **وَعَى / يَعِي** (*wa‘ā / ya‘ī*, estar ciente - Assimilado + Defectivo). Sua conjugação é complexa e melhor aprendida caso a caso.

Dominar os verbos irregulares é um passo avançado, mas essencial, pois muitos dos verbos mais frequentes pertencem a essas categorias.

**6.12 Tabelas de Conjugação Completas (Referência)**

(As Tabelas C.1 a C.8, conforme apresentadas na resposta anterior do Apêndice C, seriam inseridas aqui como referência consolidada dentro do capítulo.)

**Tabela C.1: فَعَلَ / يَفْعَلُ (*fa‘ala/yaf‘alu*) - Fazer (Modelo Regular, Raiz ف ع ل)**
**(Incluir tabela completa)**
...
**Tabela C.7: قَاتَلَ / يُقَاتِلُ (*qātala/yuqātilu*) - Lutar (Forma III, Raiz ق ت ل)**
**(Incluir tabela completa)**

**Tabela C.8: عَاشَ / يَعِيشُ (*‘āsha/ya‘īshu*) - Viver (Irregular Oco, Raiz ع ي ش)**
**(Incluir tabela completa)**

**6.13 Exercícios Abrangentes e Desafiadores sobre Verbos**

**(A): Identificação de Forma, Raiz, Tempo, Modo e Voz**
Para cada verbo Chakobsa, identifique a Raiz, a Forma Verbal (I-X), o Tempo/Aspecto, Modo, Voz (Ativa/Passiva), e dê um significado aproximado.

1.  **يُسْتَعْمَلُ** (*yusta‘malu*) [R]
2.  **تَذَكَّرْتِ** (*tadhakkarti*) [R]
3.  **لَنْ نَنْكَسِرَ** (*lan nankasira*) [R]
4.  **اُقْتُلُوا!‏** (*Uqtulū!*) [R]
5.  **قُوتِلَ** (*qūtila*) [R]
6.  **مُتَبَادَل** (*mutabādal*) [R] (Particípio)
7.  **لِتُجَاهِدِي!‏** (*li-tujāhidī!*) [R]
8.  **مَا وُجِدَ** (*mā wujida*) [R]
9.  **اِسْتَغْفِرْ!‏** (*istaghfir!*) [R]
10. **تَتَكَلَّمْنَ** (*tatakallamna*) [R]

**(B): Conjugação de Verbos (Incluindo Irregulares e Derivados)**
Conjugue os verbos dados nas formas solicitadas (Khatt al-Ibad e STP).

1.  **وَصَلَ** (*waṣala*, chegar - Assimilado F-I) no Imperfectivo Indicativo, 1ªp. Pl. ("Nós chegamos/chegaremos")
2.  **بَاعَ** (*bā‘a*, vender - Oco Ya F-I) no Perfectivo, 2ªp. Fem. Pl. ("Vós vendestes")
3.  **نَسِيَ** (*nasiya*, esquecer - Defectivo Ya F-I) no Imperfectivo Subjuntivo (após *an*), 3ªp. Masc. Pl. ("que eles esqueçam")
4.  **أَحَبَّ** (*aḥabba*, amar - Geminado F-IV) no Perfectivo, 1ªp. Sg. ("Eu amei")
5.  **عَلَّمَ** (*‘allama*, ensinar - Derivada F-II) na Voz Passiva, Imperfectivo Indicativo, 2ªp. Masc. Sg. ("Tu és ensinado")
6.  **اِجْتَمَعَ** (*ijtana‘a*, reunir-se - Derivada F-VIII) no Imperativo, 2ªp. Fem. Sg. ("Reúne-te!")
7.  **اِسْتَخْدَمَ** (*istakhdama*, usar - Derivada F-X) na Negação Passada Enfática (com *lam*), 3ªp. Masc. Sg. ("Ele não usou")

**(C): Formação da Voz Passiva (Frases)**
Transforme as frases ativas em passivas, omitindo o agente. Escreva em Khatt al-Ibad e STP.

1.  **يَفْهَمُ الطُّلابُ الدَّرْسَ۔** (*Yafhamu ṭ-ṭullābu d-darsa.*) [R] (Os estudantes entendem a lição. *ṭullāb* = estudantes).
2.  **سَيَبْنِي الفِرِمِنُ سِيَتْشًا جَدِيدًا۔** (*Sa-yabnī l-Fremenu sietchan jadīdan.*) [R/D] (Os Fremen construirão um novo sietch.)
3.  **قَدَّسَتِ السَّيِّدِينَا المَاءَ۔** (*Qaddasati s-Sayyidīnā l-mā’.*) [R/D] (A Sayyadina santificou a água.)
4.  **اِسْتَعْمَلَ المُحَارِبُ السِّكِّينَ۔** (*Ista‘mala l-muḥāribu s-sikkīn.*) [R] (O guerreiro usou a faca.)

**(D): Derivação de Particípios e Masdars (Formas Variadas)**
Dê o Particípio Ativo (PA), o Particípio Passivo (PP) e o Masdar (M) para as seguintes raízes/formas verbais.

1.  Raiz **ش ر ب** (*sh-r-b*, beber) - Forma I
2.  Raiz **د ر س** (*d-r-s*, estudar) - Forma I
3.  Raiz **ج د د** (*j-d-d*, ser novo) - Forma II (**جَدَّدَ** *jaddada*, renovar)
4.  Raiz **خ ر ج** (*kh-r-j*, sair) - Forma IV (**أَخْرَجَ** *’akhraja*, expulsar)
5.  Raiz **ع ل م** (*‘-l-m*, saber) - Forma V (**تَعَلَّمَ** *ta‘allama*, aprender)
6.  Raiz **ك س ر** (*k-s-r*, quebrar) - Forma VII (**اِنْكَسَرَ** *inkasara*, quebrar-se)

**(E): Tradução Avançada (Foco em Verbos Complexos)**

**(Chakobsa → Português):**
1.  **لَوْلا مَهَارَتُهُ، لَقُتِلَ فِي المَعْرَكَةِ الأُولَى۔** (*Lawlā mahāratuhu, la-qutila fī l-ma‘rakati l-ūlā.*) [R] (*lawlā* = se não fosse por; *mahārah* = habilidade; *la-* = certamente; *ūlā* = primeira).
2.  **يُسْتَحْسَنُ أَنْ نَسْتَعِدَّ لِلأَسْوَءِ۔** (*Yustaḥsanu an nasta‘idda lil-aswa’. *) [R] (*yustaḥsanu* = é considerado bom/preferível F-X passivo; *ista‘adda* = preparar-se F-X; *aswa’* = pior).
3.  **كَانُوا يَتَبَادَلُونَ النَّظَرَاتِ السِّرِّيَّةَ عَبْرَ الغُرْفَةِ۔** (*Kānū yatabādalūna n-naẓarāti s-sirriyyah ‘abra l-ghurfah.*) [R] (*naẓarāt* = olhares).
4.  **مَتَى سَتَتَوَقَّفُ هٰذِهِ الحَرْبُ اللَّعِينَةُ؟** (*Matā sa-tatawaqqafu hādhihi l-ḥarbu l-la‘īnah?*) [R] (*la‘īn* = maldito).
5.  **اُطْلُبِ العِلْمَ وَلَوْ كَانَ بَعِيدًا۔** (*Uṭlubi l-‘ilma wa-law kāna ba‘īdan.*) [R] (*uṭlub* = busque; *wa-law* = mesmo que).

**(Português → Chakobsa):**
1.  A água foi encontrada (passivo F-I de *wajada*) ontem perto das rochas vermelhas.
2.  Se eu tivesse sabido (F-I de *‘alima*), eu teria vindo (F-I de *jā’a*) mais cedo (*mubakkiran*). (Estrutura condicional irreal).
3.  Eles (fem.) foram ensinadas (passivo F-II de *‘allama*) a lutar (masdar F-III de *qātala*) desde a infância (*aṭ-ṭufūlah*).
4.  Pedir perdão (masdar F-X de *ghafara*) é melhor que a arrogância (masdar F-X de *kabura*).
5.  Que a paz seja restaurada (passivo F-X de *raja‘a*?) rapidamente! (Use *li-* + Jussivo Passivo).

---
**Respostas dos Exercícios do Capítulo 6**

**(A): Identificação de Forma, Raiz, Tempo, Modo e Voz**
1.  **يُسْتَعْمَلُ** (*yusta‘malu*): R: ‘-M-L; F-X; Impf. Indic. Passivo; "É usado".
2.  **تَذَكَّرْتِ** (*tadhakkarti*): R: DH-K-R; F-V; Perf. Indic. Ativo, 2Fsg; "Tu (fem.) lembraste".
3.  **لَنْ نَنْكَسِرَ** (*lan nankasira*): R: K-S-R; F-VII; Impf. Subj. Ativo (negado por *lan*), 1Pl; "Nós nunca quebraremos / seremos quebrados".
4.  **اُقْتُلُوا!‏** (*Uqtulū!*): R: Q-T-L; F-I; Imperativo Ativo, 2Mpl; "Matem!".
5.  **قُوتِلَ** (*qūtila*): R: Q-T-L; F-III; Perf. Indic. Passivo, 3Msg; "Ele foi combatido".
6.  **مُتَبَادَل** (*mutabādal*): R: B-D-L; F-VI; Particípio Passivo; "Trocado mutuamente".
7.  **لِتُجَاهِدِي!‏** (*li-tujāhidī!*): R: J-H-D; F-III; Impf. Jussivo Ativo (com *li-*), 2Fsg; "Que tu (fem.) lutes! / Luta!".
8.  **مَا وُجِدَ** (*mā wujida*): R: W-J-D; F-I; Perf. Indic. Passivo (negado por *mā*), 3Msg; "Ele não foi encontrado".
9.  **اِسْتَغْفِرْ!‏** (*istaghfir!*): R: GH-F-R; F-X; Imperativo Ativo, 2Msg; "Peça perdão!".
10. **تَتَكَلَّمْنَ** (*tatakallamna*): R: K-L-M; F-V; Impf. Indic. Ativo, 2Fpl ou 3Fpl; "Vós (fem.) falais / falareis" OU "Elas falam / falarão".

**(B): Conjugação de Verbos**
1.  Nós chegamos: **وَصَلْنَا** (*waṣalnā*)
2.  Vós (fem.) vendestes: **بِعْتُنَّ** (*bi‘tunna*)
3.  Que eles esqueçam: **أَنْ يَنْسَوْا** (*an yansaw*)
4.  Eu amei: **أَحْبَبْتُ** (*aḥbabtu*) (Geminação desfeita)
5.  Tu (masc.) és ensinado: **تُعَلَّمُ** (*tu‘allamu*)
6.  Reúne-te! (fem. sg.): **اِجْتَمِعِي!‏** (*ijtami‘ī!*)
7.  Ele não usou (enfático): **لَمْ يَسْتَخْدِمْ** (*lam yastakhdim*)

**(C): Formação da Voz Passiva**
1.  **فُهِمَ الدَّرْسُ۔** (*Fuhima d-darsu.*) (A lição foi entendida.)
2.  **سَيُبْنَى سِيَتْشٌ جَدِيدٌ۔** (*Sa-yubnā sietchun jadīd.*) (Um novo sietch será construído.) (*yubnā* passivo de *yabnī*)
3.  **قُدِّسَ المَاءُ۔** (*Quddisa l-mā’u.*) (A água foi santificada.)
4.  **اُسْتُعْمِلَ السِّكِّينُ۔** (*Ustu‘mila s-sikkīnu.*) (A faca foi usada.)

**(D): Derivação de Particípios e Masdars**
1.  R: SH-R-B (F-I): PA: **شَارِب** (*shārib*); PP: **مَشْرُوب** (*mashrūb*); M: **شُرْب** (*shurb*)
2.  R: D-R-S (F-I): PA: **دَارِس** (*dāris*); PP: **مَدْرُوس** (*madrūs*); M: **دِرَاسَة** (*dirāsah*) / **دَرْس** (*dars*)
3.  R: J-D-D (F-II): PA: **مُجَدِّد** (*mujaddid*); PP: **مُجَدَّد** (*mujaddad*); M: **تَجْدِيد** (*tajdīd*)
4.  R: KH-R-J (F-IV): PA: **مُخْرِج** (*mukhrij*); PP: **مُخْرَج** (*mukhraj*); M: **إِخْرَاج** (*ikhrāj*)
5.  R: ‘-L-M (F-V): PA: **مُتَعَلِّم** (*muta‘allim*); PP: **مُتَعَلَّم** (*muta‘allam*); M: **تَعَلُّم** (*ta‘allum*)
6.  R: K-S-R (F-VII): PA: **مُنْكَسِر** (*munkasir*); PP: (Não aplicável, verbo intransitivo); M: **اِنْكِسَار** (*inkisār*)

**(E): Tradução Avançada**
**(Chakobsa → Português):**
1.  Se não fosse por sua habilidade, ele certamente teria sido morto na primeira batalha.
2.  É preferível/considerado bom que nos preparemos para o pior.
3.  Eles estavam trocando olhares secretos através da sala.
4.  Quando esta guerra maldita vai parar/acabar?
5.  Busque o conhecimento, mesmo que esteja distante.

**(Português → Chakobsa):**
1.  A água foi encontrada ontem perto das rochas vermelhas. → **وُجِدَ المَاءُ أَمْسِ قُرْبَ الصُّخُورِ الحَمْرَاءِ۔** (*Wujida l-mā’u amsi qurba ṣ-ṣukhūri l-ḥamrā’.*) [R] (*qurba* = perto de; *ṣukhūr* = rochas).
2.  Se eu tivesse sabido, eu teria vindo mais cedo. → **لَوْ عَلِمْتُ لَجِئْتُ مُبَكِّرًا۔** (*Law ‘alimtu la-ji’tu mubakkiran.*) [R] (*law... la...* para condição irreal).
3.  Elas (fem.) foram ensinadas a lutar desde a infância. → **عُلِّمْنَ القِتَالَ مُنْذُ الطُّفُولَةِ۔** (*‘Ullimna l-qitāla mundhu ṭ-ṭufūlah.*) [R] (*mundhu* = desde).
